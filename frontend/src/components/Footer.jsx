const Footer = () => {
  return (
    <footer style={{ backgroundColor: 'var(--surface-dark)', color: 'var(--on-dark-soft)', padding: '64px 0', marginTop: 'auto' }}>
      <div className="container">
        <div className="grid grid-4" style={{ marginBottom: '48px' }}>
          <div>
            <h3 style={{ color: 'var(--on-dark)', fontFamily: 'var(--font-display)', marginBottom: '16px' }}>IB Excellence</h3>
            <p style={{ fontSize: '14px' }}>The better way to master your IB Diploma.</p>
          </div>
          <div>
            <h4 style={{ color: 'var(--on-dark)', marginBottom: '16px' }}>Product</h4>
          ...
          <div>
            <h4 style={{ color: 'var(--on-dark)', marginBottom: '16px' }}>Legal</h4>
            <ul style={{ listStyle: 'none', padding: 0, fontSize: '14px', lineHeight: '2' }}>
